...
- **Death and Decay buff reminder (Blood)** — optional glow on Death and Decay whenever the buff granted by standing in it is missing during combat. Glows the action bar button, the Cooldown Manager icon, and the tracker at once. Requires Death and Decay in the Cooldown Manager, under either Tracked Buffs or Tracked Bars.
